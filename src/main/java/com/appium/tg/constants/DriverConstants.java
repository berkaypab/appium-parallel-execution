...
import static com.appium.tg.util.PropertyReader.*;
...
public class DriverConstants {
    ...
    public static final Duration APPIUM_EXPLICIT_WAIT = Duration.ofSeconds(
            Long.parseLong(getAppiumConfig("explicit_wait_duration"))
